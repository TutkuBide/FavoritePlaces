...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let myConfig = ParseClientConfiguration { (ParseMutableClientConfiguration) in
            ParseMutableClientConfiguration.applicationId = "Np3aZYnk3BbrxaIU9LMJ0NlBLuhXjZh8LwdZMj5l"
            ParseMutableClientConfiguration.clientKey = "MwPLUmb4sNviGNE7P03gaDcrtVl0goKEga2A0m9r"
    ...
    func rememberuser() {
        ...
        if user != nil {
            ...
            let navigat = board.instantiateViewController(withIdentifier: "navigation") as! UINavigationController
